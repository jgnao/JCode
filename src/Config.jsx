...
export default function Config() {
  ...
  useEffect(() => {
    let valor = localStorage.getItem("autosave")
      ...
      <div className="main-body">
        <nav className="activity-bar">
          ...
          <div className="activity-group">
            ...
            <div className="activity-icon active" title="Configurações" type="button">
              <svg viewBox="0 0 24 24">
          ...
          <div className=" settings-page">
            ...
            <section className="setting-group">
              ...
              <div className="setting-item">
                ...
                <input type="checkbox" checked={autosave_config}
                  onChange={(e) => {
                    const ativo = e.target.checked;

                    setAutosave(ativo);
                    localStorage.setItem("autosave", ativo);
                  }} />
              </div>
            </section>
      ...
      <footer className="status-bar">
        <div className="status-left">
          <div className="status-item">
            <span className="branch-pill">⑂ Configs</span>
          </div>
        </div>
      </footer>
    </div>
